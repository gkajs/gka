...
function generateKeyFramesStr(length, distDir, prefix, nameMap) {
    var keyframesStr = '',
        percent,
        per = 100 / length,
        _index = 0;
...
module.exports =  function generateHTMLFile(length, filepath, prefix, distPath, nameMap) {
    var dimensions = sizeOf(filepath);
    var width = dimensions.width,
        height = dimensions.height;

    var keyframesStr = generateKeyFramesStr(length, 'img', prefix, nameMap);
