            ...
            unique(isUnique, src2id, (src2id) => {
                ...
                x2x(src2id, suffix, dest, prefix, isSprites, (src2distid, src2src, srcs, dists, src2dist) => {
                    ...
                    images(isSprites, {
                        ...
                        src2src: src2src,
                        algorithm: algorithm,
                        spritesFilepath: path.join(dest, "img", prefix + "-sprites" + suffix),
                    }, (obj)=>{
                        ...
                        if (opt.__len === 1) {
                            tpl && tpl.engine && tpl.engine(infoRes, tplOpt, {
                                writeFile: (name, res) => {
                            ...
                            // combine data & opt to template
                            infoResArr[opt.__index] = infoRes;
