...
function color(bgColor, data, callback) {
    if (!bgColor) {
        callback(data);
        return;
    }
    ...
    let tmpDir = path.join(global.tmpDir, 'color');
    ...
    mkdirp(tmpDir, function (err) {
        ...
        //             colorFilepath = path.join(tmpDir, filename);

        //         src2idcolor[colorFilepath] = src2id[src];
